...
var input, ul, li, a, i, txtValue, j;
var link;
...
var tekst2, data4;
function widoczek1() {document.getElementById("div1").innerHTML = console.log(widok);}
var opcja=0;
var nowaTablica = [];
...
function zwieksz(multiplier) {
  ...
  if (document.getElementById("container").style.fontSize > "2em") {alert("Za duza czcionka");} else
  document.getElementById("container").style.fontSize = parseFloat(document.getElementById("container").style.fontSize) + (multiplier * 0.1) + "em";
}
